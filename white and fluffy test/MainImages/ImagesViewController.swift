...
class ImagesViewController: UIViewController {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collection.register(ImagesCollectionViewCell.self,
                            forCellWithReuseIdentifier: ImagesCollectionViewCell.identifier)
        return collection
    }()
    func setupSearchBar() {
    ...
    private func getRandomImage(){
        ...
        debounce_timer = Timer.scheduledTimer(withTimeInterval: 0.5,
                                              repeats: false, block: { (_) in
            NetworkGetImage.shared.fetchImages(searchRequest: "") { [weak self] (randomResults) in
    ...
    private func layout(){
        ...
        NSLayoutConstraint.activate([
            viewUnderImage.topAnchor.constraint(equalTo: view.topAnchor),
            viewUnderImage.leadingAnchor.constraint(equalTo: view.leadingAnchor),
            viewUnderImage.bottomAnchor.constraint(equalTo: view.bottomAnchor),
...
extension ImagesViewController: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        DetailView.model  = image[indexPath.item]
...
extension ImagesViewController: UISearchBarDelegate {
    ...
    func searchBar(_ searchBar: UISearchBar, textDidChange searchText: String) {
        ...
        debounce_timer = Timer.scheduledTimer(withTimeInterval: 0.5,
                                              repeats: false, block: { (_) in
            NetworkGetImage.shared.fetchImages(searchRequest: searchText) { [weak self] (searchResults) in
